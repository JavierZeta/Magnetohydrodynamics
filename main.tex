...
interna orbita más rápido que la externa. Esta desunion cinemática
...
desplazamientos azimutales medidos en un sistema que corota con el
...
\label{eq:divB}
\end{align}
Estas ecuaciones las evaluaremos en el marco local corotante definido en la
